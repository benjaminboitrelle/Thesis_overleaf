...
\label{chap:ILC}
 ...
 % Before to introduce the ILC machine and explain the reasons to invest in such a project, I will give an overview of the \gls{LHC} abilities and the limits of this giant machine.
  ...
  Complementary to a discovery machine such as the \gls{LHC}, a machine to perform precise measurement should be built: the linear lepton collider.
    ...
    %radiate photon. In a linear acceleration, the radiation is called bremstrahlung and in a circular acceleration
    ...
    At the beginning of the 2000's, a committee for the future linear collider was formed and has chosen in 2004 the \gls{SRF} technology\cite{ICFA2004} and since then all the efforts are done in that direction to build the \gls{ILC}\todo{Paper on ILC}.
  ...
  \section{The ILC machine}
   ...
   \begin{figure}[!h]
    ...
    The \gls{ILC} is planed to collide electrons and positrons at a center-of-mass energy up to 500 GeV, with an energy variability down to 200 GeV for a 31 kilometers long accelerator. 
    ...
    The two beams are transported from the high energy lincas to the \gls{IR} by the \gls{BDS}, in charge to focus the beams to the sizes required to meet the \gls{ILC} luminosity wanted.
    ...
    Different kinds of soft pairs background could be expect at the \gls{ILC}: the coherent and incoherent pair production.
