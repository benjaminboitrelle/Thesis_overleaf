 ...
 \minitoc
  ...
  \section{The ILC machine}
   ...
   % They are to the number of three depending on the nature of the scattered photons creating the $e^+e^-$ pair.
    ...
    The second process is the Landau-Lifshitz, where the two scattered photons are virtual and contribute to approximately to a third of the pair creation.\todo{Sentence not clear}
