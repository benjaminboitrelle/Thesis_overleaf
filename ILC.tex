...
\label{chap:ILC}
 ...
 %   -> Talking about the \gls{ILD} (VTX, SIT, TPC, f)
  ...
  %Although the \gls{LHC} is an impressive machine able to reach a centre-of-mass energy of $13~\rm{TeV}$, the complex environment of the events generated hides the access to some fundamental parameters. 
  Although the \gls{LHC} is an impressive machine able to reach a centre-of-mass energy of $13~\rm{TeV}$, the complex environment of the events makes more difficult to access some fundamental parameters. 
  ...
  %To achieve more precise measurements of the Higgs boson, but also to test the validity of the \gls{SM} and other physics theories introduced in the chapter \ref{chap:SM}, the high energy physics community has united on the necessity to build a linear electron-positron collider, that will work as a complementary accelerator to the \gls{LHC}.
 ...
 % Before to introduce the ILC machine and explain the reasons to invest in such a project, I will give an overview of the \gls{LHC} abilities and the limits of this giant machine.
  ...
  The goals of the \gls{LHC} are to perform tests of the \gls{SM}, search for new forces or particles. 
...
%  Unfortunately, due to the nature of the particles used, the experiment can not reach the highest precision measurements needed.
  ...
  %Complementary to a discovery machine such as the \gls{LHC}, a machine to perform precise measurement should be built: the linear electron collider.
  ...
  The advantages of linear electron collider will be presented in the following.
    ...
    Therefore, the initial four-vector momentum is not known.\todo{WHY??}
    ...
    Although the electron and positron, have clearer advantages on hadrons to perform a precise measurement, the choice of a linear collider comes from the physics of accelerating charged particles.
    ...
    Equation~\ref{eq:Esynchrotron} describe the energy loss via synchrotron radiation:
    ...
    \todo{Move CLIC and muon collider to the top}
  ...
  \section{The ILC machine}
    ...
    In 2016, the physics community was waiting for an official decision of the Japan government concerning the final experimental site. \todo{Reference}
    At the time when this thesis was written, the most likely site candidate is located in the north of Japan, in the region of Kitakami. 
   ...
   \begin{figure}[!h]
    ...
    The \gls{ILC} is planned to collide electrons and positrons at a center-of-mass energy up to $500~\rm{GeV}$, with an energy variability down to $240~\rm{GeV}$ for 31 kilometers long accelerator. 
    ...
    The polarised electrons are produced by a laser firing into strained GaAs photocathode in a \gls{DC} gun.
    ...
    The electrons are then pre-accelerate to $76~\rm{MeV}$ using non-superconducting accelerating structures.
    ...
    \todo{Write TDR values, see Marcel talk}
    ...
    Contrary to the \gls{LHC}, the \gls{ILC} will not suffer from QCD background, as mentioned in subsection~\ref{subsec:advLLC}
  ...
  As it was presented in subsection~\ref{subsec:design}, the \gls{ILC} will be built with only one interaction region due to cost reasons, whereas two detectors are foreseen.
