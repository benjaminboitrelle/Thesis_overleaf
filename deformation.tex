\chapter{Deformation studies of a ladder in the test beam}
\label{chap:deformation}
  ...
  \section{Test beam of the full complete PLUME ladder at CERN}
    ...
    The test beam was performed at the \gls{CERN}-\gls{SPS} in the North hall at the H6 beam line~\cite{SPS}.
  ...
  \section{Spatial resolution studies}
    ...
    \label{subsec:deformation}
      ...
      \subsubsection{Origin of the observed deviations}
      ...
      Another additional parameter has to be taken into account to explain the deviation observed.
      ...
      The $\omega_{k}$ are the coefficients that quantify the sensor curvature and the $P_{k}(u_{r})$ are the Legendre polynomials defined as:
  ...
  In this section, the resolution of the measurement of this angle is studied.
    ...
    A theoretical estimation of the uncertainty on the spatial resolution for the mini-vector is given by:
    ...
    %The measurement of the residual for the mini-vector displayed in figure~\ref{fig:residualMV} gives a residual of $\sigma_{\rm{m}} = 3.2 \pm 0.026 ~\rm{\mu m}$.
   ...
   %A selection of the events where only clusters of 1 pixel are considered is shown in figure~\ref{fig:angRes1x1}.
   ...
   %Hence, the peaks are two times closer with a spacing of nearly $0.25^{\degree}$, as seen in figures~\ref{fig:angRes2x1} and~\ref{fig:angRes2x2}.
