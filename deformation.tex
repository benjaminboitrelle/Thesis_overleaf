\chapter{Deformation studies of a ladder under the test beam}
  ...
  \section{Test beam of the full complete PLUME ladder at CERN}
   ...
   % The telescope is made of two arms, on each side of the \gls{DUT} and the distance between two sensors of the same arm is 5 mm.
    ...
    The figure~\ref{fig:labCoordinates} summarises the definition of the two coordinate systems.\todo{Draw a better figure}
  ...
  \section{Spatial resolution studies}
    ...
    The $z$ position is determined by the position measured during the test beam campaign and is not considered as a free parameter due to the beam used.
      ...
      After aligning the telescope, a track candidate is dismissed if it is made of less than four hits or if the $\chi^2$ fit is greater than a fixed value determined by the user. 
      ...
      This results is corroborating the pointing resolution of a single MIMOSA-26, as shown on figure~\ref{fig:mi26Perf} in chapter~\ref{chap:vxd}.

    \subsection{Ladder tilted in one direction}
    \label{subsec:deformation}

      The performances of the \gls{DUT} is also studied for tilted tracks by rotating the ladder with respect to the beam axis along the $v$-direction.
      ...
      Indeed, the scatter plot in the $v$-direction shown on figure~\ref{fig:scaterDVV_deformed} represents a good alignment and the spatial residual (see figure~\ref{fig:resdualVDef}) is comparable to the one find for normal incidence tracks.
      ...
      %For the run studied here, the tilt is around $36^{\degree}$, the threshold sets to 5 $\sigma$ and the air flow speed was 3 $\text{m.s}^{-1}$.
      ...
      \begin{figure}
        ...
        \end{subfigure}
        \caption{Distribution of the residuals obtained for the DUT with a tilt of $36^{\degree}$ for the front sensor: \ref{fig:scatterDUU_deformed} $\Delta u = f(u_{hit})$,
        ...
        Residual distributions in the $u$ and $v$ directions for the middle telescope planes.}
      ...
      Nevertheless, the gluing procedure to the flex-cable and the \gls{SiC} foam induces permanent deformations of the surface that can not be flatten.
      ...
      It has non-functioning MIMOSA-20 sensors that were thinned and attached to the standard flex-circuits.
      ...
      An other parameter has to be taken into account to explain the deviation observed.
      ...
      The method implemented in TAF was inspired from the work which was done by the CMS collaboration.
      ...
      Different order of the Legendre polynomials were tried, as shown on the figure~\ref{fig:legFit} to find the best function.
      The coefficients obtained after fitting are used to parametrise the surface's shape and the position of the hit.
      The table~\ref{tab:chi2} summarises the different $\chi^2 \text{/NDF}$ obtained for different order, as well as the residual measured in the $u$-direction after correction.
   
      \begin{figure}
        %\centering
        \missingfigure{legendre fits}
        \caption{Fit of the track-hit residuals as a function of the hit position in the same direction}
        \label{fig:legFit}
      \end{figure}
      ...
      \begin{table}
        ...
        \begin{tabular}{c c c c c}
          ...
          \hline %----------------------------
          \hline %----------------------------
          3 & 21683.9/84 & 4.874 & 35575.2/72 & 9.972 \tabularnewline
          4 & 1449.91/83 & 4.505 & 25129.8/71 & 9.166 \tabularnewline
          5 & 1449.79/82 & 5.101 & 1718.81/70 & 5.523 \tabularnewline
          6 & 653.738/81 & 4.534 & 1480.55/69 & 5.442 \tabularnewline
          7 & 304.206/80 & 4.497 & 634.696/68 & 5.17 \tabularnewline
          8 & 288.376/79 & 4.507 & 269.296/67 & 5.001 \tabularnewline
          9 & 225.376/78 & 4.486 & 250.565/66 & 4.978 \tabularnewline
          10 & 225.353/77 & 4.497 & 152.236/65 & 4.975 \tabularnewline
          11 & 158.053/76 & 4.483 & 131.727/64 & 4.978 \tabularnewline
          \hline %----------------------------
         \end{tabular}
      ...
      A second-order Legendre function does not provide a good improvement on the compensation of deformation.
      Different orders were tested to fit the $\Delta U=f(u)$, as shown on figure~\ref{fig:legFit}.
      The best improvement was achieved on both side from the $8^{th}$ order Legendre polynomials to higher values.
      Although the $\chi^2 \text{/NDF}$ is better for higher order, the width of the residual distribution is of the same order ($\sigma_{front}\simeq 4.5 \text{ }\mu\text{m}$ and $\sigma_{back} \simeq 5.0 \text{ }\mu\text{m}$).
      The figure~\ref{fig:scatterFitted} depicts the fit results for the ... plane. 

      For example, using a $11^{th}$ order Legendre polynomials has improved the spatial residual for both planes. 
      Instead of $\sigma_{u} \simeq 6.8 \text{ }\mu\text{m}$ for the front plane, the spatial residual is $\sigma_{u} \simeq 4.5 \text{ }\mu\text{m}$, namely an improvement of 33.8 \% of the measured spatial residual and achieving a pointing resolution of $4.1 \text{ }\mu\text{m}$ for a tilt at $36^{\degree}$.
      Concerning the back plane, the spatial residual measured was $12.5 \text{ }\mu\text{m}$ and after the correction it achieves $4.9 \text{ }\mu\text{m}$, namely an improvement of 60 \% on the measured spatial residual.
      The point resolution of the plane is then $4.6 \text{ }\mu\text{m}$
      ...
      On the back plane, a bump is still visible on the middle of the scatter plot (see figure~\ref{fig:scatterDUU_corrected_back}).
      This may be due to a missing information on the deformation of the sensor on the other direction.
      ...
      \begin{figure}
        ...
        \begin{subfigure}[t]{0.45\textwidth}
          \centering
          \includegraphics[width = 1.2\textwidth]{Pictures/deformation/deltaUU_8_corrected.png}
          \caption{}
        ...
        \begin{subfigure}[t]{0.45\textwidth}
          \centering
          \includegraphics[width = 1.2\textwidth]{Pictures/deformation/deltaU_8_corrected.png}
          \caption{}
          \label{fig:residualU_corrected}
        \end{subfigure}
        \caption{Results of the alignment after applying the Legendre polynomials correction and tacking into account the angle of the incoming particles: \ref{fig:scatterDUU_corrected} $\Delta u=f(u_{hit})$ and \ref{fig:residualU_corrected} distribution of the residuals.}
  ...
  This has the effect to increase the spatial residual measured.
  A higher point resolution is expected for bending tracks but in a smaller proportion.
  An algorithm using Legendre polynomials to describe the sensor's shape was discussed.
  The results obtained after correction are close to the value expected for the MIMOSA-26 sensors.
  It might be possible that the heating is increasing the deformation and that the cooling system could induce some vibrations which induce some deformation too.
  ...
  For normal incidence, the pointing resolution of the mini-vector, which is the combination of the pointing resolution on each side,  is better than the spatial resolution for a single sensor.
  Moreover, the mini-vectors give access to an other information: the angular resolution.
  Due to the binary output and the centre-of-gravity hit position reconstruction, peaks are visible and a simple Gaussian fit can not be used. 
  The same work has to be done with ladder titled with respect to the test beam.
  The results can confirm that the algorithm to correct the deviation is working correctly.
