...
\label{chap:deformation}
  ...
  The first full-scale prototype which embeds twelve sensors glued on a copper flex-cable and a 8 \% density \gls{SiC} foam was tested in November 2011 at \gls{CERN}-\gls{SPS} facility, with a pion beam of $120~\rm{GeV}$.
  ...
  \section{Test beam of the full complete PLUME ladder at CERN}
    ...
    The test beam was performed at \gls{CERN}-\gls{SPS} in the North hall on the H6 beam line~\cite{SPS}.
