...
\label{chap:deformation}
  ...
  \section{Spatial resolution studies}
    ...
    \label{subsec:deformation}
      ...
      \end{table}
      \todo{Specify if telescope res or not}

      A hypothesis on the origin of the deformation might come from heating or the cooling system that induces vibration.
  ...
  In this section, the resolution on this angle is studied.
    ...
    The resolution of the mini-vector should be then $\sigma_{\rm{res}} = 2.8 \pm 0.1~\rm{\mu m}$.
    ...
    Taking into account the resolution of the telescope ($\sigma_{\rm{tel}} = 1.8 \pm 0.5~\rm{\mu m}$), the spatial resolution achieved by the mini-vector is $\sigma_{\rm{res}} = 2.9 \pm 0.1~\rm{\mu m}$.
