...
\label{chap:vxd}
  ...
  Actually, the lifetime of the two quarks is of the same magnitude ($1.3 \time 10^{-12}$ s for the $b$ quark and $1.1 \time 10^{-12}$ s for the $c$ quarks), leading to  very close decay vertices. 
  ...
  \section{The ILD vertex detector specifications}
   ...
   \end{equation}
    ...
    The second term presented in the equation~\ref{eq:bTerm}, is related to the multiple scattering inducing an uncertainty on the impact parameter.
