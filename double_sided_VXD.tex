...
\label{chap:vxd}
  ...
  %Along this chapter, the role of the vertex detector and the physics requirements in building one suited for the \gls{ILC} environment will be presented.
  ...
  %To measure particles with a short lifetime ($\simeq 10^{12}$s) that have a decay length between 150 and 500 $\mu$m, 
  ...
  \section{The ILD vertex detector specifications}
   ...
   %The resolution on the impact parameter $\sigma_{IP}$, defined as the distance of closest approach of the particle to the colliding beam can be parametrised by the formula~\ref{eq:resIP}.\todo{REPHRASE}
    ...
    Where $\theta$ is the track polar angle.
   ...
   The \gls{VXD} is made of 12 cm long ladders arranged cylindrically in concentric layers to form long-barrels surrounding the \gls{IP}, contrary to the \gls{SiD} vertex detector with a design based on a 5 layers barrel, four endcap disks and three additional forward pixel disks\cite{Behnke2010}.
