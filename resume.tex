...
%\chapter{Résumé de la thèse\markboth{Résumé de la thèse}{Résumé de la thèse}} \addcontentsline{toc}{chapter}{\protect\numberline{}Résumé de la thèse}
 ...
 % \end{sidewaystable}
  ...
  Ainsi, grâce aux plans de référence utilisés en faisceau test, il est possible de suivre le passage des particules avant et après avoir traversé notre échelle PLUME et de mesurer cet angle déflexion.
  ...
  \begin{itemize}
    ...
    \item deux flex composés deux pistes métalisées en cuivre et protégées par trois couches de Kapton :
    \begin{itemize}
  ...
  Il est supposé que la proportion des couches de cuivre représentent entre $25~\%$ et $30~\%$ du flex.
  ...
  Ce qui représente un longueur de radiation toalte de :
  ...
  L'ajustement n'est effectué sur l'interval correspondant à la largeur à mi-hauteur de la distribution, car les queues de la distribution sont plus larges.
  ...
  La figure~\ref{fig:theta0_2-4} est un histogramme représentant l'angle de déflexion mesuré en fonction de l'énergie des particules incidentes sur lequel est ajusté l'équation de Highland (voir ~\ref{eq:MSC}), en gardant la longueur de radiation comme paramètre libre d'ajustement.
  Ainsi, le budget de matière mesuré est de $0.47 \pm 0.02~\%$ of $\rm{X_0}$, en deça de l'estimation théorique.
  Cette mesure a été effectuée en prenant en compte les deux capteurs \gls{CMOS} de l'échelle pour mesure le parcours des particules.
  Comme le signal créé est supposé se trouve au milieu de la couche epitaxiée, une petite partie du capteur n'est pas prise en compte.
  Ceci correspond pour les deux capteurs à $0.028~\%$ de $\rm{X_{0}}$ manquant.

  Afin d'améliorer cette mesure, des prises de données de calibration peuvent être effecutées.
  En plaçant différent matériaux dont le budget de matière est précisement connu, il est possible d'estimer un biais de mesure qui sera ensuite inclus dans notre calcul final.
   \begin{figure}[!h]
     \centering
     ...
     Cette courbe est ajustée par la formule d'Highland (voir l'équation~\ref{eq:MSC}), où la longueur de radiation est un paramêtre libre.}
