...
%\chapter{Résumé de la thèse\markboth{Résumé de la thèse}{Résumé de la thèse}} \addcontentsline{toc}{chapter}{\protect\numberline{}Résumé de la thèse}
 ...
 % \end{sidewaystable}
  ...
  Pour ces échelles, les couches de cuivre représentant entre $25~\%$ et $30~\%$ de la composition du flex.
  ...
  Cet ajustement n'est effectué que sur un interval réduit, correspondant à l'écart-type de la distribution.
  ...
  Comme le signal est considéré comme créé au milieu de la couche epitaxiée, une petite partie du capteur n'est pas prise en compte.
