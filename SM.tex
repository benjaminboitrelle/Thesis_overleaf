\chapter{Secrets of the nature}
  ...
  \section{The Standard Model}
    ...
    \lettrine{\textgoth{T}}{he} Standard Model (SM) is a theory that describes the fundamental structure of the matter surrounding us. 
    ...
    %The particle physics community is interested to understand the secrets of the universe and the matter. 
    %The community tries to identify all the fundamental particles in the universe and to understand how the fundamental interactions are behaving on those fundamental particles.

    %Thanks to the experimental observations and the birth of some theories, physicists were able to write a whole theory called the Standard Model (SM).
