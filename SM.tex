\chapter{Secrets of the nature}
 ...
 \minitoc
  \section{The Standard Model}
    ...
    The elegant theoretical framework of the SM is able to provide good explanations of experimental results, but is also able to predict a wide variety of phenomena.
    ...
    The two other generations are particles that can be found in cosmic rays or in collision with accelerators.
...
%    the existence of a mechanism to generate the particle masses via the Higgs mechanism.
    ...
    The first component of the Lagrangian density corresponds to the kinetic term of a complex scalar field, while the second one is related to a scalar potential.
    ...
    The origin of the fermions masses is solved in the SM thanks to the Higgs-Englert-Brout mechanism \cite{PhysRevLett.13.508}\cite{1964PhRvL..13..321E}.
...
%    \end{equation}
   ...
   \end{equation} 
    ...
    The Higgs mass can not be predicted by the theory because it is given by a function of the parameter $\lambda$, which is one of the free parameters of the SM.
...
%    the existence of a mechanism to generate the particle masses via the Higgs mechanism.
  ...
  The SM constitutes one of the most successful achievement in modern physics.
  ...
  Despite the fact that the experimental results are not contradictory to the SM, the theory is far away to be the answer to all the questions.
  ...
  An exhaustive list of some limitations are going to be presented.
    ...
    The SM does not predict its mass, but it sets some theoretical bounds with respect to $\Lambda$, the scale energy at which the SM is not valid anymore.
    ...
    there is no viable theory to describe the gravity in a quantum point of view to include it in the SM and which would be still valid at a macro-scale.
   ...
   % \todo{Rephrase dark matter and dark energy}
    ...
    \subsection{Theories beyond the Standard Model}
      ...
      The Supersymmetry (SUSY) is a QFT, that relates the elementary fermions known to corresponding bosons, called sfermions and the bosons to corresponding fermions, sbosons.
