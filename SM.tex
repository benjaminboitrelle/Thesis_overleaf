...
%  After that, we will study the electroweak interaction and the spontaneous symmetry breaking. We will finally discuss the limits of the theory and the possible solutions to overcome these issues. 
  ...
  \section{The Standard Model}
    ...
    The \acrfull{SM} is a theory that describes the elementary structure of the matter. 
  ...
  \end{table}
    ...
    \todo{Subsubsection: symmetries}
     ...
     The $U(1)$ gauge group is a unitary group of one dimension which is invariant under space transformations.
      ...
      Although the mass term of the Lagrangian in equation~\ref{eq:diracLag} stays invariant under the local symmetry, the term containing a partial derivative is not anymore.
...
\mathcal{L}_{weak} = \frac{G_F}{\sqrt{2}}\left(\overline{p} \gamma_{\mu} n \right) \left(\overline{e} \gamma_{\mu} \nu \right)
    ...
    In equation~\ref{eq:Wmunu}, $\textbf{W}_{\mu} = \sum W^i_{\mu}\sigma^i/2$ is a vector of three gauge fields associated to $SU(2)_L$ and $\sigma^i$ are the Pauli matrices. 
    The term $[\textbf{W}_{\mu},\textbf{W}_{\nu}]$ is associated to the interactions between the gauge fields.
    In equation~\ref{eq:Bmu}, $\textbf{B}_{\mu}$ is the only gauge field associated to the $U(1)_Y$.
...
%    the existence of a mechanism to generate the particle masses via the Higgs mechanism.
    ...
    By adding the new field in equation~\ref{eq:ssbLagrangian}, the Lagrangian becomes:
    ...
    As we have seen with the Lagrangian of the QED and QCD, the bosons generated are massless. Nevertheless, the W$^{\pm}$ and the $Z$ bosons have a mass and equation~\ref{eq:ewLag} of the EW interaction does not include a mass generator. 
    ...
    The covariant derivative is the one of $SU(2)_L \otimes U(1)_Y$ given by equation~\ref{eq:derivativeEW} and represents the kinetic term.
