...
\label{chap:phyics}
 ...
 \minitoc
  ...
  By varying the energy of the beam around this threshold (called threshold scan), the mass of the top quark will be measured with a precision reaching $100~\rm{MeV/c}^2$.
  ...
  The production, the decay modes of the Higgs boson, as well as the measurement feasible are presented below in the case of the \gls{ILC}.
    ...
    The mass of the Higgs boson measured at the \gls{LHC} is $m_{H} = 125. \pm ~\rm{GeV}$.
    ...
    Although the decay $H \rightarrow b\overline{b}$ is the dominant decay mode of the Higgs boson at hadrons colliders, the existence of the boson was observed by studying the di-photon channel.
