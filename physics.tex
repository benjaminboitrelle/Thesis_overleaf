...
%    A deviation might indicate multiple states for the Higgs boson. \todo{Not clear enough}
    ...
    The \gls{LHC} has permit to exclude a spin-1 to the Higgs boson with the observation of the di-photon channel.
  ...
  \section{Analysis of simulated data}
    ...
    The results shown here are not the last update and are already demonstrated\todo{Citation: thesis Felix}. 
