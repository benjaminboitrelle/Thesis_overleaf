...
\section{Electrical validation}
 ...
 % After the connections were controlled and before to connect the module to the bench, the different voltages has to be set.
  ...
  The most flexible cable was not used for two reasons.
  The first one is due to the high resistivity that implies an important voltage drop between the auxiliary board and the module.
  The second reason is that the cable was not mounted and grounded correctly.
  The sensors were not working correctly and the only solution to resolve the problem was to by-pass the digital and analog voltages, by applying them externally from the pads located at the edge opposite to the connector.
  The stiffest cable has a low voltage drop and was used during the test.
  Nevertheless, due to the stiffnessthe stiffness of the cable requires a mechanical structure to hold the whole system to reduce the mechanical stress on the connector of the module, which is a sensitive part.\todo{Details of voltage drop inside the jumper cable and the flex-cable}
...
\section{Noise measurements}
  ...
  It is the one used to characterise the PLUME modules.
...
\section{Conclusions}
  ...
  In January 2016, an entire copper prototype was assembled.
  The aluminum prototypes are more challenging to build. 
  Indeed, all the mirrored versions produced till ... have grounded problem due to a more fragile connector, that could have been damaged by plugging and unplugging the jumper cable.
